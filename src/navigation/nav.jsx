  ...
  return(
       <div className="navBlock">
         ...
         <div className="navigation-block">
           ...
           <Link to="/home" className={`${Call("/") ? "nav-link lighting" : "nav-link"} ${Call("/home") ? "nav-link lighting" : "nav-link"}`}>Home</Link>
           <Link to="/brand_experiences" className={`${Call("/brand_experiences") ? "nav-link lighting" : "nav-link"}`}>Services</Link>
