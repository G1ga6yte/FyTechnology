...
import AllBlock from "./allBlocks/allBlocks";

function AllExperiences (){
  return(
     <div style={{marginTop: "100px"}} className="AllExperiences">
       <div className="experiencesMainBlock">
         <div className="topLine"></div>
         <div className="vector-radialBlocksAll">
         ...
         <div className="header-text">
           ...
           <p className="background-text">Our Services</p>
         </div>
